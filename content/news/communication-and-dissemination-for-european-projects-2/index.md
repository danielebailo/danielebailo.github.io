---
title: "Communication and Dissemination for European Projects (#2)"
date: 2015-09-21
translationKey: "communication-and-dissemination-for-european-projects-2"
categories: 
  - "job"
  - "technology-ict"
tags: 
  ...
  - "wp2"
cover:
  image: "images/pavan-trikutam-1660.jpg"
  alt: ""
  caption: ""
  relative: true
---

In  a [previous post](http://www.danielebailo.it/communication-and-dissemination-for-european-projects-1/) we introduced the importance of communication within the context of European funded Projects, and we defined three different modules to establish an efficient communication:
...
- **Sub-Objective1**: Participation of SME to project events;
    ...
    - **Action1**: PMO invites SME to project's events by means of email invitations
        - **KPI for Action1**: _number of invites / number of participants_ ratio
...
**And socials?** The website should include also news and interactions from social networks. However the website should be simple enough to allow almost anyone with basic IT skill to add pages, articles, images.
...
Comments and feedbacks are more than welcome. _And please share your experience._
...
HEADER IMAGE Photo by [Pavan Trikutam](https://unsplash.com/photos/71CjSSB83Wo?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText) on [Unsplash](https://unsplash.com/?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText)
